    ...
    async def run_pipeline(
        ...
        if self.resolver:
            try:
                ...
                # Resolution agent's final_status is authoritative for strong/good matches
                resolution_status = resolution.get("_final_status")
                if resolution_status and match_quality in ("strong", "good") and not risk.get("escalate"):
