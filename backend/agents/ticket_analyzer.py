...
_SUB_CATEGORY_KEYWORDS: dict[str, dict[str, list[str]]] = {
    "network": {
        ...
        "firewall":       ["firewall", "blocked", "port", "traffic blocked", "connection refused", "access blocked", "npm install certificate error", "ssl verification failed", "self signed certificate", "corporate proxy block"],
    },
    "access": {
        "password_reset": ["forgot password", "reset password", "password reset", "change password", "expired password"],
        "locked_out":     ["locked out", "account locked", "too many attempts", "lockout", "account expired", "sso login", "saml redirect", "federation authentication", "identity provider error"],
        "mfa":            ["mfa", "2fa", "two factor", "authenticator", "otp", "one time password", "verification code"],
        "permission":     ["permission", "access denied", "forbidden", "no permission", "privilege", "access request", "role", "git push fails", "permission denied publickey", "ssh key not accepted", "developer credential"],
    ...
    "software": {
        ...
        "update":         ["update", "patch", "upgrade", "windows update", "software version", "bsod after update", "boot loop after update", "rollback update"],
        ...
        "configuration":  ["group policy", "gpo", "domain", "registry", "bitlocker", "encryption", "compliance", "folder in use", "file locked", "file lock", "open in another program", "docker daemon", "port already in use", " wsl "],
    },
    "hardware": {
        "peripheral":     ["printer", "scanner", "keyboard", "mouse", "usb", "headset", "speaker", "wi-fi adapter", "wireless adapter", "wi-fi card", "network adapter missing"],
        "display":        ["monitor", "screen", "display", "resolution", "hdmi", "displayport", "flicker", "artifact", "projector"],
        "audio_video":    ["webcam", "camera", "microphone", "mic", "audio", "video call", "no sound", "voip", "phone", "headset not working", "mic not detected", "microphone not detected", "no sound in headset"],
        "system_crash":   ["blue screen", "bsod", "kernel", "crash", "stop error", "reboot loop", "bios"],
        "storage":        ["hard drive", "ssd", "disk", "storage", "hdd", "bad sector", "smart", "low disk space", "disk full", "out of storage", "disk space warning", "no space"],
